...
export const ProductEditPage = (props) => {
  ...
  const uploadFileHandler = async (e) => {
    ...
    try {
      const { data } = await Axios.post('https://hd1111.herokuapp.com/api/uploads', bodyFormData, {
        headers: {
  ...
  return (
    <div>
      <form className="form" onSubmit={submitHandler}>
        ...
        {loadingUpdate && <LoadingBoxComp></LoadingBoxComp>}
        ...
        {loading ? (
          ...
          <>
            ...
            <div>
              ...
              ></input>
              {loadingUpload && <LoadingBoxComp></LoadingBoxComp>}
              {errorUpload && (
